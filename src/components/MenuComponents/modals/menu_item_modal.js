...
const mapDispatchToProps = dispatch => ({
  ...
  addItem: (id, name, price, quantity, itemInstructions, restaurantId, restaurantName, deliveryMinimum, deliveryFee, itemOptionSections, options) => dispatch(addItem(id, name, price, quantity, itemInstructions, restaurantId, restaurantName, deliveryMinimum, deliveryFee, itemOptionSections, options)),
...
class MenuItemModal extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.menuItem.itemOptionSections.forEach(itemOptionSection => {
      let option;
  ...
  addItem() {
    ...
    const id = this.props.menuItem.productId;
    ...
    const itemOptionSections = this.props.menuItem.itemOptionSections;
    ...
    this.props.addItem(id, name, price, quantity, itemInstructions, restaurantId, restaurantName, deliveryMinimum, deliveryFee, itemOptionSections, options);
  ...
  render() {
    const { id, name, price, description, itemOptionSections } = this.props.menuItem;
    const { quantityError, itemInstructionsError, requiredOptionsError, clearErrors } = this.props;

    const itemOptionSectionsBuild = itemOptionSections.map(itemOptionSection => {
